		...
		load: function load ( id ) {
			...
			if ( startsWith( id, PREFIX ) ) {
				...
				if (commonjsModules.has( actualId$1 ))
					...
					{ return ("import * as " + name$1 + " from " + (JSON.stringify( actualId$1 )) + "; export default " + name$1 + ";"); } // HACK: TO FIX https://github.com/rollup/rollup/issues/1859 https://github.com/rollup/rollup-plugin-commonjs/issues/308
			}
		},
